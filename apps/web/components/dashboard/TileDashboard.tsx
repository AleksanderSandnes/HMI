...
function SolarSection({ model }: { model: DashboardModel }) {
  ...
  return (
    <>
      ...
      />
      <div className="grid auto-rows-fr grid-cols-2 gap-3 md:grid-cols-4 lg:portrait:grid-cols-2 lg:min-h-0 lg:flex-1">
        <DualStat
          icon={Zap}
          gradient="solar"
...
function WeatherSection({ model }: { model: DashboardModel }) {
  ...
  return (
    <>
      ...
      />
      <div className="grid auto-rows-fr grid-cols-2 gap-3 md:grid-cols-4 lg:portrait:grid-cols-2 lg:min-h-0 lg:flex-[2]">
...
/** Desktop dashboard (lg+): page header + the full stat-tile grids. */
export function TileDashboard({ model }: { model: DashboardModel }) {
  const { t } = useI18n();
  const { device } = model;
  return (

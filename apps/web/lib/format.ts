...
// Sensor payloads arrive as loosely-typed numbers (or null/NaN), so every tile
// needs the same null-safe coercion + "—" fallback — centralised here instead
// of being re-declared per component.

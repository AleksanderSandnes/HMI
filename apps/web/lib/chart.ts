// Pure chart-geometry helpers shared by the Solar/Weather Recharts components.
// Kept out of the components so the (non-obvious) axis math can be unit-tested.
 ...
 * chunky bars. Stays strictly below 50 — Recharts collapses bars to zero width
 * at exactly barCategoryGap="50%".
 */

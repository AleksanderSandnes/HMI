  ...
  return (
    <>
      <Text style={{ fontSize: 20, color: 'white', marginBottom: 20 }}>
        {neighborhood},{' '}
        <Text style={{ fontSize: 18, color: 'lightgray' }}>{countryName}</Text>
      </Text>

      {precipRate !== null && <WeatherIcon precipRate={precipRate} />}

      <Text
        style={{ fontSize: 40, color: 'white', marginTop: 20, marginBottom: 5 }}
      >
        {temp} °C
      </Text>
      <Text style={{ fontSize: 20, color: 'lightgray', marginBottom: 20 }}>
        {weatherText}
      </Text>
      ...
      <HStack style={{ flexDirection: 'row', alignItems: 'center' }}>
        ...
        />
        <Text style={{ fontSize: 20, color: 'white', marginRight: 40 }}>
